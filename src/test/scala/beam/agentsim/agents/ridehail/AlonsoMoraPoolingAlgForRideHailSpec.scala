        ...
        rvGraph.getEdgeSource(e).getId match {
          ...
          case "p2" =>
            assert(
              ...
              rvGraph.getEdgeTarget(e).getId.equals("p4"))
          case "p3" =>
            assert(rvGraph.getEdgeTarget(e).getId.equals("p2"))
          case "p4" =>
            assert(
              rvGraph.getEdgeTarget(e).getId.equals("p1") ||
              rvGraph.getEdgeTarget(e).getId.equals("p2"))
...
object AlonsoMoraPoolingAlgForRideHailSpec {
  ...
  def scenario1(
      ...
      mockActorRef: ActorRef): (List[VehicleAndSchedule], List[CustomerRequest]) = {
  ...
  def demandSpatialIndex(demand: List[CustomerRequest]): QuadTree[CustomerRequest] = {
    ...
    val spatialDemand =
      new QuadTree[CustomerRequest](boundingBox.getMinX, boundingBox.getMinY, boundingBox.getMaxX, boundingBox.getMaxY)
    demand.foreach { d =>
