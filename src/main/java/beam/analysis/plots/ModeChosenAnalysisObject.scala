...
object ModeChosenAnalysisObject extends OutputDataDescriptor {
  ...
  def getOutputDataDescriptions: util.List[OutputDataDescription] = {
    val modeChoiceOutputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getOutputFilename(modeChoiceFileBaseName + ".csv")
    val referenceModeChoiceOutputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getOutputFilename(referenceModeChoiceFileBaseName + ".csv")
    ...
    list.add(OutputDataDescription(getClass.getSimpleName, modeChoiceRelativePath, "iterations", "iteration number"))
    list.add(OutputDataDescription(getClass.getSimpleName, modeChoiceRelativePath, "car", "Car chosen as travel mode"))
    list.add(
    ...
    list.add(
      OutputDataDescription(getClass.getSimpleName, modeChoiceRelativePath, "walk", "Walk chosen as travel mode"))
    list.add(
      OutputDataDescription(
        getClass.getSimpleName,
        modeChoiceRelativePath,
    ...
    list.add(OutputDataDescription(getClass.getSimpleName, referenceModeChoiceRelativePath, "bike", "iteration number"))
    list.add(
      OutputDataDescription(
        getClass.getSimpleName,
        referenceModeChoiceRelativePath,
