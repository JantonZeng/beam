...
object GraphSurgePricingObject extends OutputDataDescriptor {
  ...
  override def getOutputDataDescriptions: util.List[OutputDataDescription] = {
    val surgePricingOutputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getIterationFilename(0, "rideHailSurgePriceLevel.csv")
    val revenueOutputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getIterationFilename(0, "rideHailRevenue.csv")
    val surgePricingAndRevenueOutputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getIterationFilename(0, "tazRideHailSurgePriceLevel.csv")
    ...
    list.add(OutputDataDescription(getClass.getSimpleName, surgePricingRelativePath, "Hour", "Hour of the day"))
    list.add(
      OutputDataDescription(
        getClass.getSimpleName,
        revenueRelativePath,
    ...
    list.add(OutputDataDescription(getClass.getSimpleName, surgePricingAndRevenueRelativePath, "TazId", "TAZ id"))
    list.add(
      OutputDataDescription(
        getClass.getSimpleName,
    ...
    list.add(
      OutputDataDescription(getClass.getSimpleName, surgePricingAndRevenueRelativePath, "Hour", "Hour of the day"))
    list
  }
