...
object RideHailRevenueAnalysisObject extends OutputDataDescriptor {
  ...
  def getOutputDataDescriptions: util.List[OutputDataDescription] = {
    val outputFilePath: String =
      GraphsStatsAgentSimEventsListener.CONTROLLER_IO.getOutputFilename(fileBaseName + ".csv")
    ...
    list.add(OutputDataDescription(getClass.getSimpleName, relativePath, "revenue", "Revenue generated from ride hail"))
    list
  }
