...
object AvailableModeUtils extends LazyLogging {
  ...
  def getExcludedModesForPerson(population: Population, personId: String): Array[String] = {
    Option(population.getPersonAttributes.getAttribute(personId, PopulationAdjustment.EXCLUDED_MODES))
  ...
  def setAvailableModesForPerson(person: Person, population: Population, permissibleModes: Seq[String]): Unit = {
    val attributesOfIndividual =
      person.getCustomAttributes.get(PopulationAdjustment.BEAM_ATTRIBUTES).asInstanceOf[AttributesOfIndividual]
  ...
  def setModesForPerson(
      ...
      attributesOfIndividual: AttributesOfIndividual): Unit = {
  ...
  def setAvailableModesForPerson_v2(
      ...
      person: Person,
      population: Population,
      permissibleModes: Seq[String]): Unit = {
    val attributesOfIndividual =
      Option(person.getCustomAttributes.get(PopulationAdjustment.BEAM_ATTRIBUTES).asInstanceOf[AttributesOfIndividual])
        .getOrElse {
  ...
  def isModeAvailableForPerson[T <: BeamMode](person: Person, mode: BeamMode): Boolean = {
